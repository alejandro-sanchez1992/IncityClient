...
namespace IncityClient.Common.Services
{
    public class ApiService : IApiService
    {
        ...
        public async Task<Response<object>> GetTokenAsync(string urlBase, string servicePrefix, string controller, FacebookProfile request)
        {
            try
            {
                string requestString = JsonConvert.SerializeObject(request);
