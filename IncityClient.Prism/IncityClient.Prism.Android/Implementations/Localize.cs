...
using IncityClient.Prism.Interfaces;
using IncityClient.Prism.Helpers;
using Xamarin.Forms;

[assembly: Dependency(typeof(IncityClient.Prism.Droid.Implementations.Localize))]
namespace IncityClient.Prism.Droid.Implementations
{
